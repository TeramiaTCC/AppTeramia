...
const StackR = [
  ...
  { route: 'NewPost', title: 'Criar Publicação', type: Icons.Feather, icon: 'x-circle', component: NewPost, color: Colors.white, bckgClr: Colors.backColor, mrgRgt: -20, hdrOpt: false },
